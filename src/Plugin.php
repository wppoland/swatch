...
final class Plugin
{
    ...
    {
        return SWATCH_URL . ltrim($path, '/');
    }

    /**
     * Absolute filesystem path to a bundled file, relative to the plugin root.
     */
    public function path(string $path = ''): string
    {
        return SWATCH_DIR . ltrim($path, '/');
    }
